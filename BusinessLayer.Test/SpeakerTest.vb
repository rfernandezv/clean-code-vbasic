...
<TestClass()> Public Class SpeakerTest
    ...
    <TestMethod()>
    <ExpectedException(GetType(HandlerException), "_")>
    ...
    Public Sub Register_DoesntAppearExceptionalAndUsingOldBrowser_ThrowsNoSessionsApprovedException()
        ...
        speakerThatDoesntAppearExceptional.Browser = New WebBrowser(WebBrowser.BrowserName.InternetExplorer, 6)
    ...
    Function GetSpeakerWithRedFlags() As Speaker
        ...
        speaker.Browser = New WebBrowser(WebBrowser.BrowserName.InternetExplorer, 6)
        Return speaker
    End Function
